...
public class CachedExternalQueryServiceTest {
    ...
    public void testUsesCachedFileWhenItIsStilLValid() throws IOException {
        ...
        CachedExternalQueryService queryService = new CachedExternalQueryService(new MemoryCache(), checker);
        List<EveLocation> locations = queryService.get("test", ResponseParsers::parseLocations, url).get();
        ...
        List<EveLocation> shouldBeCached = queryService.get("test", ResponseParsers::parseLocations, url).get();
