...
@Value
@Builder
@JsonDeserialize(builder = CrestApiMarketOrder.CrestApiMarketOrderBuilder.class)
public class CrestApiMarketOrder {
    ...
    public static class CrestApiMarketOrderBuilder {
    }
}
